        ...
        <div className="embla-desktop" ref={emblaRef}>
          <div className="embla__container">
            <div className="embla__slide">
              ...
              />
              <p>
                <b>Часть №1 — </b> Заразиха подсолнечника. День Поля Компании Беркана.
              </p>
            </div>
            <div className="embla__slide">
              <ReactPlayer
              ...
              />
              <p>
                <b>Часть №2 — </b> Заразиха подсолнечника. День Поля Компании Беркана.
              </p>
            </div>
            <div className="embla__slide">
              <ReactPlayer
              ...
              />
              <p>
                <b>Часть №3 — </b> Заразиха подсолнечника. День Поля Компании Беркана.
              </p>
            </div>
            <div className="embla__slide">
              <ReactPlayer
              ...
              />
              <p>
                <b>Часть №4 — </b> Заразиха подсолнечника. День Поля Компании Беркана.
              </p>
            </div>
            <div className="embla__slide">
              <ReactPlayer
              ...
              />
              <p>
                <b>Часть №5 — </b> Заразиха подсолнечника. День Поля Компании Беркана.
              </p>
            </div>
          </div>
