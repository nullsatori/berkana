      ...
      <div className="flex">
        <div className="left">
          <div className="wrapper">
            ...
            <div className="links">
              <a href="@/components/general/footer/index">О компании</a>
              <a href="@/components/general/footer/index">Агропроект</a>
              <a href="@/components/general/footer/index">Новости</a>
              <a href="@/components/general/footer/index">Средства защиты</a>
              <a href="@/components/general/footer/index">Наши партнеры</a>
              <a href="@/components/general/footer/index">Семена</a>
              <a href="@/components/general/footer/index">Контакты</a>
              <a href="@/components/general/footer/index">Услуги</a>
            </div>
